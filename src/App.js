...
const [monState, setMonState] = useState([
  ...
  {tache: 'Préparer le repas', txt : 'acheter les ingrediens'},
  {tache: 'Creer une app web', txt : 'Apprendre React'}
])
            ...
            <form onSubmit={creationCarte}>
              ...
              <div className="field">
                <div className="control">
                  ...
                  type="text"
                  id='tache'
                  placeholder='Ecrivez une tâche à faire' 
              ...
              <div className="field">
                <div className="control">
                  <label htmlFor='txt'className='label'>Contenu de ma tâche</label>
                  <textarea
                  value={txt}
                  className='textarea'
                  type="text"
